    ...
    <main className="relative bg-background text-foreground overflow-x-hidden">
      ...
      >
        ...
        <div className="hidden md:flex items-center space-x-8 text-sm font-medium tracking-widest uppercase">
          <a href="#practices" className="hover:text-accent transition-colors">
            Practices
          </a>
          ...
          <a
            href="#contact"
            className="px-5 py-2 border border-accent text-accent hover:bg-accent hover:text-primary transition-all rounded-full magnetic-btn"
          >
            Free Consultation
          </a>
        </div>
      ...
      {isMenuOpen && (
        ...
        >
          ...
          <a
            href="#contact"
            onClick={() => setIsMenuOpen(false)}
            className="px-8 py-3 bg-accent text-primary rounded-full text-xl font-bold"
          >
            Free Consultation
          </a>
        </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl">
          ...
          <p className="text-xl md:text-2xl text-gray-400 max-w-2xl mx-auto mb-12 font-light leading-relaxed">
            The Law Office of Osbelia Castillo combines aggressive litigation
            experience with a personalized, tech-forward approach to secure the
            results you deserve.
          </p>
        ...
        <div className="absolute bottom-0 left-0 w-full bg-accent/10 border-t border-accent/20 py-4 overflow-hidden whitespace-nowrap">
          <div className="gsap-marquee inline-block">
            {[...settlements, ...settlements, ...settlements].map((item, i) => (
              <span
                key={i}
                className="mx-8 text-sm font-bold tracking-widest uppercase inline-flex items-center gap-2"
              >
      ...
      <section id="practices" className="py-32 px-6 max-w-7xl mx-auto reveal">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div className="max-w-2xl">
            <h2 className="text-sm font-bold tracking-[0.3em] uppercase text-accent mb-4">
              Our Practices
            </h2>
            <h3 className="text-4xl md:text-6xl font-serif font-bold leading-tight">
              Strategic Expertise for <span className="italic">Complex</span>{" "}
              Cases
            </h3>
          </div>
          <p className="text-gray-400 max-w-sm mb-2">
            Leveraging deep defense-side experience to give our clients an
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[300px] md:auto-rows-[240px]">
          ...
          <div className="md:col-span-8 md:row-span-2 group relative overflow-hidden rounded-3xl bg-emerald-deep/20 border border-white/5 p-8 flex flex-col justify-end">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 max-w-md mb-6">
                Accidents and injuries are inevitable, but being
                under-compensated shouldn't be. We handle catastrophic injuries
          ...
          <div className="md:col-span-4 md:row-span-1 group relative overflow-hidden rounded-3xl bg-accent/5 border border-accent/10 p-8 flex flex-col justify-center">
            ...
            <p className="text-sm text-gray-400">
              Highways, side streets, or parking lots. We navigate the
              complexities of road liability.
            </p>
          </div>
          ...
          <div className="md:col-span-4 md:row-span-2 group relative overflow-hidden rounded-3xl bg-white/5 border border-white/10 p-8 flex flex-col">
            ...
            <p className="text-gray-400 mb-8">
              Protecting your right to a safe workplace and ensuring medical
              coverage after on-the-job injuries.
            </p>
          ...
          <div className="md:col-span-4 md:row-span-1 group relative overflow-hidden rounded-3xl bg-emerald-deep/40 border border-white/5 p-8 flex flex-col justify-center">
            ...
            <p className="text-sm text-gray-400">
              Seeking justice for families who have lost loved ones due to
          ...
          <div className="md:col-span-4 md:row-span-1 group relative overflow-hidden rounded-3xl bg-accent border border-accent p-8 flex flex-col justify-center text-primary">
            ...
            <p className="text-sm font-medium opacity-80">
              Hold healthcare providers accountable for their standard of care.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="about" className="py-32 bg-accent/5 overflow-hidden reveal">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="reveal-about">
            <h2 className="text-sm font-bold tracking-[0.3em] uppercase text-accent mb-6">
              The Castillo Edge
            </h2>
            <h3 className="text-4xl md:text-5xl font-serif font-bold leading-tight mb-8">
              A Unique Perspective From the{" "}
              <span className="text-accent">Inside</span>.
            </h3>
            <div className="space-y-6 text-gray-400 text-lg leading-relaxed">
              <p>
                For over five years, Osbelia worked as an aggressive civil
                litigator representing insurance companies in both state and
                federal court. This experience gives her an unparalleled edge
                when fighting for her injured clients.
              </p>
              <p>
                Having handled hundreds of personal injury cases including
                catastrophic injuries, wrongful deaths, and traumatic brain
                injuries from the defense side, she possesses a unique ability
                to anticipate the opposition's moves and achieve favorable
      ...
      <section id="process" className="py-32 px-6 reveal">
        <div className="max-w-4xl mx-auto text-center mb-24">
          ...
          <h3 className="text-4xl md:text-6xl font-serif font-bold mb-8">
            Defining Goals, Method & <span className="italic">Success</span>{" "}
            Together
          </h3>
          <p className="text-xl text-gray-400 font-light">
            Our approach saves our clients time and money over the long term
            through proactive domination and strategic assessment.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div
              key={idx}
              className="reveal-card p-10 rounded-3xl bg-white/5 border border-white/10 hover:border-accent/50 transition-colors group"
            >
            ...
            <form className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-[0.2em] font-bold text-gray-500">
                    First Name
                  </label>
                  <input
                    type="text"
                    className="w-full bg-transparent border-b border-white/10 py-3 outline-none focus:border-accent transition-colors text-lg"
                    placeholder="Jane"
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  rows={4}
                  className="w-full bg-transparent border-b border-white/10 py-3 outline-none focus:border-accent transition-colors text-lg resize-none"
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-12">
          <div>
            ...
            <p className="text-gray-500 max-w-sm text-sm">
              Premium legal representation for the modern era. Specializing in
              high-stakes personal injury and litigation defense.
            </p>
          </div>
